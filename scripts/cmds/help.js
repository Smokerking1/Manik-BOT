...
const doNotDelete = "[ 🌟 | MR SANNY-𝗕𝗢𝗧 ]";

module.exports = {
  config: {
    name: "help",
    version: "1.17",
    author: "MR.SANNY", //**orginal author fb I'd : https://m.me/NOOBS.DEVELOPER.AYAN **//
    countDown: 5,
    role: 0,
    shortDescription: {
  ...
  if (args.length === 0) {
      ...
      msg += `𝗧𝘆𝗽𝗲 ${prefix}𝗵𝗲𝗹𝗽 [NR SANY-𝗕𝗢𝗧] 𝘁𝗼 𝘃𝗶𝗲𝘄 𝘁𝗵𝗲 𝗱𝗲𝘁𝗮𝗶𝗹𝘀 𝗼𝗳 𝘁𝗵𝗮𝘁 𝗰𝗼𝗺𝗺𝗮𝗻𝗱\n`;
      msg += `🌟 | NR SANY-𝗕𝗢𝗧 `;
